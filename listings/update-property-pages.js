...
for (let i = 2; i <= 15; i++) {
    ...
    // Update the favicon link if it exists, or add it if it doesn't
    if (!fileContent.includes('<link rel="icon"')) {
        fileContent = fileContent.replace(
            '<head>',
            '<head>\n    <link rel="icon" type="image/png" href="../images/Logos/Artboard 1 copy.png">'
        );
    }
...
console.log('All property pages have been updated with the new styling.');
